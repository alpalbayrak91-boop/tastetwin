...
- TMDB token ayari, metadata onbellegi ve watchlist siralama servisi eklenmeli.
...
- 10.000 kisilik ag taramasi Letterboxd hiz sinirlarina baglidir; ilerleme kaydi ve kaldigi yerden devam eklenmeli.
